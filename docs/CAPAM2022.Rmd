...
```
.footnote[Lowndes et al. 2017 <br><br>]
...
.footnote[Reichman et al. 2011. <br><br>]
...
```
The x axis represents alternative text representations of the same term.
...
```{r validator, echo=FALSE, out.width="700px", fig.align="center"}
