...
xlsx_path <- here::here("StockAssessment", "top20_analysis.xlsx")
...
word_frequency <- apply(frequency_database[, 4:ncol(frequency_database)], 2, sum)
word_presence <- apply(presence_database[,4:ncol(presence_database)], 2, sum)
word_proportion <- apply(proportion_database[,4:ncol(proportion_database)], 2, mean)
...
# barplot
jpeg(filename = here::here("StockAssessment", "top20_barplot.jpg"), width=200, height=120, units="mm", res=1200)
...
jpeg(filename = here::here("StockAssessment", "top20_presence.jpg"), width=200, height=120, units="mm", res=1200)
...
# wordcloud figure
jpeg(filename= here::here("StockAssessment", "top20_wordcloud.jpg"), width=200, height=200, units="mm", res=1200)
