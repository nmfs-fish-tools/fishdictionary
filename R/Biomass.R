#' Biomass
#'
#' Mass of fish within a stock. If referring to a certain portion of the
...
#' \item{Synonym or Similar Terms}{stock biomass, total biomass, abundance (numbers of fish),
