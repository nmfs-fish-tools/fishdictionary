...
xlsx_path <- here::here("StockAssessment", "top10_analysis.xlsx")
...
jpeg(filename = here::here("StockAssessment", "top10_barplot.jpg"), width=300, height=270, units="mm", res=1200)
